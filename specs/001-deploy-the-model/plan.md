...
```
# Option 1: ML/Data Science Project (DEFAULT for this project)
src/
...
# Option 2: Single deployment file (for simple deployments)
deploy/
...
**Structure Decision**: DEFAULT to Option 1 (ML Project) for this disaster tweet classification project. Use Option 2 (Single deployment file) for simple deployment scenarios.
